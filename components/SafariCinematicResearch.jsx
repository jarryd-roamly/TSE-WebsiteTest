...
// SafariCinematicResearch.jsx — v3
// Uses direct MP4 video sources (Mixkit free CDN) — no YouTube, no controls possible
// <video autoPlay muted loop playsInline> = full browser control, zero UI chrome
//
// HOW TO USE IN page.tsx:
//   {screen === 'inspire-research' && (
//     <SafariCinematicResearch
//       answers={{ experience, regions: selectedRegions, nights, travellers, budget: fmt(budget) }}
//       aiReady={itinerary !== null}
//       onComplete={() => setScreen('builder')}
//     />
//   )}
//
// Remove setScreen('builder') from runEngine — onComplete drives the transition.

import { useState, useEffect, useRef, useCallback } from 'react';

// ─── Region video mapping — Mixkit free CDN ──────────────────────────────────
// No YouTube. No iframe. No controls. Pure <video> tags.
// All Mixkit videos are free for web use: https://mixkit.co/license/
const REGION_CLIPS = {
  'kruger':           [
    { mp4: 'https://assets.mixkit.co/videos/preview/mixkit-lion-in-the-savanna-at-sunset-34607-large.mp4',          accent: '#C8A96E', name: 'Sabi Sand',      country: 'South Africa', tagline: 'Where leopards walk at noon',          stat: '12 min',     statLabel: 'avg leopard sighting' },
    { mp4: 'https://assets.mixkit.co/videos/preview/mixkit-cheetah-running-through-the-savannah-2742-large.mp4',     accent: '#C8A96E', name: 'Sabi Sand',      country: 'South Africa', tagline: 'Where leopards walk at noon',          stat: '12 min',     statLabel: 'avg leopard sighting' },
  ],
  'kruger-sabi-sand': [
    { mp4: 'https://assets.mixkit.co/videos/preview/mixkit-lion-in-the-savanna-at-sunset-34607-large.mp4',          accent: '#C8A96E', name: 'Sabi Sand',      country: 'South Africa', tagline: 'Where leopards walk at noon',          stat: '12 min',     statLabel: 'avg leopard sighting' },
    { mp4: 'https://assets.mixkit.co/videos/preview/mixkit-cheetah-running-through-the-savannah-2742-large.mp4',     accent: '#C8A96E', name: 'Sabi Sand',      country: 'South Africa', tagline: 'Where leopards walk at noon',          stat: '12 min',     statLabel: 'avg leopard sighting' },
  ...
  'okavango':         [
    { mp4: 'https://assets.mixkit.co/videos/preview/mixkit-african-elephant-walking-in-the-savanna-34609-large.mp4', accent: '#7EB8A0', name: 'Okavango Delta', country: 'Botswana',     tagline: 'A river that flows into the sky',      stat: '11,000 km²', statLabel: 'of pristine wilderness' },
    { mp4: 'https://assets.mixkit.co/videos/preview/mixkit-hippos-swimming-in-a-river-34605-large.mp4',              accent: '#7EB8A0', name: 'Okavango Delta', country: 'Botswana',     tagline: 'A river that flows into the sky',      stat: '11,000 km²', statLabel: 'of pristine wilderness' },
  ],
  'okavango-delta':   [
    { mp4: 'https://assets.mixkit.co/videos/preview/mixkit-african-elephant-walking-in-the-savanna-34609-large.mp4', accent: '#7EB8A0', name: 'Okavango Delta', country: 'Botswana',     tagline: 'A river that flows into the sky',      stat: '11,000 km²', statLabel: 'of pristine wilderness' },
    { mp4: 'https://assets.mixkit.co/videos/preview/mixkit-hippos-swimming-in-a-river-34605-large.mp4',              accent: '#7EB8A0', name: 'Okavango Delta', country: 'Botswana',     tagline: 'A river that flows into the sky',      stat: '11,000 km²', statLabel: 'of pristine wilderness' },
  ...
  'chobe':            [
    { mp4: 'https://assets.mixkit.co/videos/preview/mixkit-buffalo-herd-grazing-in-savanna-34611-large.mp4',         accent: '#8FC4D4', name: 'Victoria Falls', country: 'Zimbabwe',     tagline: 'The smoke that thunders',              stat: '108m',       statLabel: 'of pure vertical power' },
    { mp4: 'https://assets.mixkit.co/videos/preview/mixkit-aerial-view-of-an-african-savannah-and-a-river-34606-large.mp4', accent: '#8FC4D4', name: 'Victoria Falls', country: 'Zimbabwe', tagline: 'The smoke that thunders',             stat: '108m',       statLabel: 'of pure vertical power' },
  ],
  'chobe-vic-falls':  [
    { mp4: 'https://assets.mixkit.co/videos/preview/mixkit-buffalo-herd-grazing-in-savanna-34611-large.mp4',         accent: '#8FC4D4', name: 'Victoria Falls', country: 'Zimbabwe',     tagline: 'The smoke that thunders',              stat: '108m',       statLabel: 'of pure vertical power' },
    { mp4: 'https://assets.mixkit.co/videos/preview/mixkit-aerial-view-of-an-african-savannah-and-a-river-34606-large.mp4', accent: '#8FC4D4', name: 'Victoria Falls', country: 'Zimbabwe', tagline: 'The smoke that thunders',             stat: '108m',       statLabel: 'of pure vertical power' },
  ...
  'cape-town':        [
    { mp4: 'https://assets.mixkit.co/videos/preview/mixkit-waves-in-the-sea-on-a-sunset-99-large.mp4',               accent: '#B8C4A0', name: 'Cape Town',      country: 'South Africa', tagline: 'Where two oceans meet the mountain',   stat: 'Top 3',      statLabel: 'most beautiful cities' },
    { mp4: 'https://assets.mixkit.co/videos/preview/mixkit-going-down-a-curved-road-in-a-mountain-38-large.mp4',     accent: '#B8C4A0', name: 'Cape Town',      country: 'South Africa', tagline: 'Where two oceans meet the mountain',   stat: 'Top 3',      statLabel: 'most beautiful cities' },
  ],
  'madikwe':          [
    { mp4: 'https://assets.mixkit.co/videos/preview/mixkit-rhino-walking-in-the-savanna-34608-large.mp4',            accent: '#C8A96E', name: 'Madikwe',        country: 'South Africa', tagline: 'Big Five. Malaria-free. Unforgettable', stat: '75,000',    statLabel: 'hectares of wilderness' },
    { mp4: 'https://assets.mixkit.co/videos/preview/mixkit-zebras-grazing-in-the-savanna-34610-large.mp4',           accent: '#C8A96E', name: 'Madikwe',        country: 'South Africa', tagline: 'Big Five. Malaria-free. Unforgettable', stat: '75,000',    statLabel: 'hectares of wilderness' },
  ],
  'masai-mara':       [
    { mp4: 'https://assets.mixkit.co/videos/preview/mixkit-lion-in-the-savanna-at-sunset-34607-large.mp4',           accent: '#D4874A', name: 'Masai Mara',     country: 'Kenya',        tagline: 'The greatest show on earth',           stat: '1.5M',       statLabel: 'wildebeest in migration' },
    { mp4: 'https://assets.mixkit.co/videos/preview/mixkit-zebras-grazing-in-the-savanna-34610-large.mp4',           accent: '#D4874A', name: 'Masai Mara',     country: 'Kenya',        tagline: 'The greatest show on earth',           stat: '1.5M',       statLabel: 'wildebeest in migration' },
  ],
};
...
export default function SafariCinematicResearch({ answers = {}, aiReady = false, onComplete }) {
  ...
  // Build 2-clip sequence from selected regions
  const clips = (() => {
    ...
    const result = chosen.map(slug => (REGION_CLIPS[slug] || FALLBACK_CLIPS)[0]);
    if (result.length === 1) {
      const slug = valid[0] || 'kruger-sabi-sand';
  ...
  const [activeVid,         setActiveVid]         = useState('A');
  ...
  const loadClip = useCallback((index, slot) => {
    const clip = clips[index];
    if (!clip) return;
    const vid = slot === 'A' ? vidARef.current : vidBRef.current;
    if (vid) {
      vid.src = clip.mp4;
      vid.load();
      vid.play().catch(() => {});
  ...
  return (
    <>
      <style suppressHydrationWarning>{`
        ...
        .scr-vid { position:absolute;inset:0;width:100%;height:100%;object-fit:cover;opacity:0;transition:opacity 1.4s ease; }
        .scr-vid.show { opacity:1; }
        .scr-ov { position:absolute;inset:0;background:linear-gradient(to bottom,rgba(0,0,0,.5) 0%,rgba(0,0,0,0) 40%,rgba(0,0,0,0) 55%,rgba(0,0,0,.75) 100%); }
        .scr-vg { position:absolute;inset:0;background:radial-gradient(ellipse at center,transparent 20%,rgba(0,0,0,.5) 100%); }
      ...
      <div className="scr-root">
        ...
        <div className="scr-scan" />
        <div className="scr-c tl" /><div className="scr-c tr" />
        <div className="scr-c bl" /><div className="scr-c br" />

        {/* ── CINEMATIC: direct <video> tags, zero controls */}
        <div className="scr-vid-layer">
          <video
            ref={vidARef}
            className={`scr-vid ${activeVid === 'A' ? 'show' : ''}`}
            autoPlay muted loop playsInline
          />
          <video
            ref={vidBRef}
            className={`scr-vid ${activeVid === 'B' ? 'show' : ''}`}
          ...
          <div className="scr-tleft">
            ...
            <div className="scr-tleft-c">
              ...
              <div className="scr-pills">
                {pills.map((p, i) => (
                  <div key={i} className="scr-pill"><div className="scr-pdot" />{p}</div>
                ))}
              </div>
            </div>
          </div>
                  ...
                  return (
                    <div key={i} className={`scr-titem ${isLatest ? 'lat' : ''}`}>
                      <div className="scr-tico">
                        {isLatest ? <div className="scr-adot" /> : <div className="scr-ddot" />}
                      </div>
        ...
        <div className={`scr-reveal ${phase === 'reveal' ? 'visible' : ''}`}>
          <div className="scr-dring">
            <div className="scr-do" /><div className="scr-dm" /><div className="scr-dc" />
          </div>
