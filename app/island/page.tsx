...
const ISLANDS = [
  ...
  { name: 'Seychelles',  tagline: 'Ancient granite paradise',  image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&q=80',  icon: '◈' },
...
const JOURNEYS = [
  ...
  { name: 'Seychelles & Zanzibar',        tagline: 'La Digue · Praslin · Pemba Island',          nights: 10, priceFrom: 340000,  otaPrice: 465000,  badge: 'Two-island escape',badgeColor: '#A78BFA', image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&q=80' },
...
const OTHER_EDITIONS = [
  { id: 'safari', name: 'The Safari Edition', icon: '◆', desc: 'Sub-Saharan Africa · Active', color: '#D4AF37', available: true },
  { id: 'ski',    name: 'The Ski Edition',    icon: '◇', desc: 'Alps · Aspen · Hokkaido', color: '#A78BFA', available: false },
  { id: 'japan',  name: 'The Japan Edition',  icon: '◇', desc: 'Tokyo · Kyoto · Hokkaido', color: '#F87171', available: false },
];
              ...
              {editionOpen && (
                <div className="ie-edition-menu">
                  ...
                  {OTHER_EDITIONS.map(e => (
                    <div key={e.id} className="ie-edition-item" style={{ opacity: e.available ? 0.8 : 0.45 }}>
                      <span style={{ fontSize: 14, color: e.color }}>{e.icon}</span>
                      <div style={{ flex: 1 }}>
                        <div style={{ fontSize: 12, color: 'rgba(240,235,228,0.65)', fontWeight: 400 }}>{e.name}</div>
                        <div style={{ fontSize: 10, color: 'rgba(240,235,228,0.3)' }}>{e.desc}</div>
                      </div>
                      {e.available
                        ? <span className="ie-edition-available">Active</span>
